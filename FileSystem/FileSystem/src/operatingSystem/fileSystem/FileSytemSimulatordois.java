...
public class FileSytemSimulatordois extends javax.swing.JFrame {

    Kernel myKernel = null;
    
    /** Creates new form SSH */
    public FileSytemSimulatordois(Kernel myKernel) {
        initComponents();
    ...
    private void txtCommandKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCommandKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            command = command.substring((this.base.length()+FileSytemSimulatordois.currentDir.length()+2), command.length());
    ...
    private void txtCommandKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCommandKeyReleased
        if( this.txtCommand.getText().length() <= (this.base.length()+FileSytemSimulatordois.currentDir.length()+2) || this.txtCommand.getText().length() == 0 ){
            this.escreverDiretorio();
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FileSytemSimulatordois(null).setVisible(true);
            }
        });
    }
    ...
    private void escreverDiretorio(){
        this.txtCommand.setText(this.base+FileSytemSimulatordois.currentDir+"$ ");
    }
